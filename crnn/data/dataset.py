...
if __name__ == '__main__':
    # frame = read_from_txt('/home/liumihan/PycharmProjects/ocr/crnn/data/data1/txt/val.txt')
    dataset = TextDataset(txt_file='/home/liumihan/PycharmProjects/ocr/crnn/data/data1/txt/val.txt',
                          root_dir='/home/liumihan/PycharmProjects/ocr/crnn/data/data1/img',
                          max_label_length=13,
                          transform=transforms.Compose([Gray(), ToTensor()]))
    chars = CharClasses('/home/liumihan/PycharmProjects/ocr/crnn/data/data1/txt/m_char_std_5990.txt')
    data = dataset[0]
    image = data['image']
    image = image.numpy()
